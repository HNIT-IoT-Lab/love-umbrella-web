  ...
  <div class="app-container">
    ...
    <el-table :data="tableData" border style="width: 100%">
      ...
      <el-table-column prop="actualDuration" label="实际花费时长" width="70">
        <template slot-scope="scope">
          <span v-if="scope.row.status === '02' && scope.row.isAudited === 1"
            >{{ scope.row.actualDuration }} 小时</span
          >
    ...
    >
      <el-form ref="form" :model="activityInfo" label-width="100px">
        ...
        <el-form-item label="所需人数">
          <el-input
            v-model="activityInfo.numberOfNeed"
            type="number"
          ></el-input>
        </el-form-item>
        ...
        <el-form-item label="奖励(学分)">
          <el-input
            v-model="activityInfo.rewardPoints"
            type="number"
          ></el-input>
        </el-form-item>
        <el-form-item label="预计花费时长(小时)">
          <el-input
            v-model="activityInfo.predictDuration"
            type="number"
          ></el-input>
        </el-form-item>
        ...
        <el-form-item label="活动描述">
          <el-input
            v-model="activityInfo.description"
            type="textarea"
          ></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    dateChange() {
      if (
        this.activityDate[0] != undefined &&
        this.activityDate[1] != undefined
      ) {
